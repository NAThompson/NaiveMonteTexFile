...
There is additional structure in the one pass mean calculation that could perhaps be exploited more effectively, but the idea is demonstrably effective (see \mintinline{bash}{kahan_avg.cpp}) and the error bound is improved to
